...
static final String[] menus=new String[]{"콩비지동그랑땡","누드김밥","쪽파 새우강회","카레토마토달걀볶음밥","식빵고구마파이","배추만두","당근잎 감자전","단호박 고등어조림","나물 월남쌈","애호박 구이","오이보트카나페","가지두부스테이크","깻잎장아찌","고추장아찌","민트라임모히또","어린잎샌드위치","호박무침","가지무침과 호박잎쌈밥","상추 치커리 오징어 초침무","가지그라탕","매운가지볶음","고구마잎무침","닭가슴살 호박말이","토마토미니새송이볶음","오이동치미","돛나물 부추 오이무침","가지말이구이","바질페스토 스파게티","시금치들깨수제비","단호박옥수수치즈구이","감동젓무김치","보쌈김치","시래기돼지갈비찜","흑임자삼계죽","한우토마토스튜","시금치표고된장무른밥","시금치배미음죽","쌀샐러드","까르보나라 (한국식)","송어샐러드","잉어찜","메기매운탕","비빔냉면","미소된장국","꽁치김치찌개","떡만두국","채소피클","발효초요구르트","쫄면","김치우동","해물순두부찌개","해물매운탕","새송이쌈장구이","해물볶음밥","오코노미야키","두부조림","돼지고기김치찌개","해물찌개","고추잡채와꽃빵","두부파프리카전","참치죽","고추장닭강정","된장채소수제비","치킨샐러드","무쌈말이","바베큐립","부추올리브오일무침","버섯잡채","가지김치","상추미소국","크림소스파스타","녹두고물호박떡케이크","토란닭고기찜","삼색나물월남쌈","소꼬리찜","왕새우구이와구운채소","전어회무침","대대로닭칼국수","서리태콩국수","모듬콩수프","우무콩냉국","녹차콩국수","시금치나물","죽순회와미나리강회","전복죽","새우죽","낙지연포탕","시금치계란말이","돼지갈비레몬찜","파프리카볶음밥","붉은갓동치미","깻잎말이김치","된장찌개","근대된장국","고구마강정","고추장","된장","간장","얼갈이열무물김치","깻잎조림","쌀국수","마늘볶음국수","수삼치즈샐러드","채소치즈죽","치즈멸치볼","새우겨자채","갈치조림"
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recipeOutput = findViewById(R.id.recipeOutput);
         final AutoCompleteTextView  searchRecipe = findViewById(R.id.searchRecipe);
